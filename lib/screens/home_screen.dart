...
import 'package:images/utils/banner.dart';
  ...
  Widget build(BuildContext context) {
    return Consumer<HomeProvider>(
      builder: (context, value, child) {
        final reversedPhotos = value.photos.reversed.toList();
        return Scaffold(
                    ...
                    child: ListView(
                      children: [
                        if (value.photos.isNotEmpty)
                          BannerImage(image: value.photos.last),
                        GridView.builder(
                          shrinkWrap: true,
                          ...
                          itemBuilder: (context, index) {
                            return ImageListCard(photo: reversedPhotos[index]);
                          },
                        ),
                      ],
                    ),
